...
import LocationPicker from '@/components/common/LocationPicker'; // Import component bản đồ
...
export default function CreateWarehouseModal({ isOpen, onClose, onWarehouseCreated }) {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            onWarehouseCreated(); // Gọi lại hàm để fetch lại danh sách kho
            handleClose(); // Đóng và reset modal
        } catch (err) {
            const message = err.response?.data?.message || 'Failed to create warehouse.';
            setError(message);
